...
import java.util.List;
    ...
    public class ModPlacedFeatures {
        public static final DeferredRegister<PlacedFeature> PLACED_FEATURE =
                DeferredRegister.create(Registry.PLACED_FEATURE_REGISTRY, GW.MOD_ID);

        public static final RegistryObject<PlacedFeature> AMBER_ORE_PLACED = PLACED_FEATURE.register("amber_ore_placed",
                () -> new PlacedFeature(ModConfiguredFeatures.AMBER_ORE.getHolder().get(),
                        commonOrePlacement(1,
                                HeightRangePlacement.triangle(VerticalAnchor.absolute(60), VerticalAnchor.absolute(68)))));
